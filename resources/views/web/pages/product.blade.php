...
@section('content')
                ...
                <div class="product-info">
                    <div class="product-header">
                        <div class="net">
                            ...
                            <div class="net-logo">
                                <img src="{{\App\Models\Developer\CropImage::getCropImageUrl($product->shop->net, 'logo')}}" alt="{{$product->shop->net->title}}">
                            </div>
                    ...
                    <div class="product-footer">
                        ...
                        <a class="show-code" href="/bar-code/{{$product->id}}#bar-code">Показать штрихкод</a>
                    </div>
                </div>
    ...
    @if (count($products))
    <section class="next-to">
        <div class="container">
            <h2>Другие товары</h2>
            <div class="product-list">
                <div class="row">
                    @include('web.components.products', ['products' => $products, 'class' => 'col-lg-3 col-md-4'])
                </div>
            </div>
        </div>
    </section>
