            ...
            <div class="form">
                ...
                <div class="form-wrap">
                    ...
                    <form method="post" action="{{ route('password.update') }}">
                        ...
                        @include('components.interface.fields.simple', ['slug' => 'email', 'value' => $email ?? old('email')])
                        @include('components.interface.fields.password', ['slug' => 'password'])
                        @include('components.interface.fields.password', ['slug' => 'password_confirmation', 'required' => true])
